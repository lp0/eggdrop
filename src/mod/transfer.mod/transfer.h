...
/* 4 - 7 */
#define DCC_FORK_SEND \
(*(struct dcc_table *)(transfer_funcs[4]))
#define at_limit(a) \
(((int (*) (char *))transfer_funcs[5])(a))
#define copy_to_tmp \
(*(int *)(transfer_funcs[6]))
#define fileq_cancel(a,b) \
(((void (*) (int,char *))transfer_funcs[7])(a,b))
/* 8 - 11 */
#define queue_file(a,b,c,d) \
...
#define show_queued_files(a) \
(((void (*) (int))transfer_funcs[10])(a))
#define wild_match_file(a,b) \
(((int (*)(register unsigned char * m, register unsigned char * n))transfer_funcs[11])(a,b))
/* 12 - 15 */
#define wipe_tmp_filename(a,b) \
(((void (*) (char *,int))transfer_funcs[12])(a,b))
#define DCC_GET \
(*(struct dcc_table *)(transfer_funcs[13]))
